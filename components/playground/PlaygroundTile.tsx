...
export const PlaygroundTile: React.FC<PlaygroundTileProps> = ({
  ...
  return (
    <div
      className={`flex flex-col border rounded-sm border-gray-800 text-teal-500 bg-${backgroundColor} ${className}`}
    >
      {title && (
        <div
          className="flex items-center justify-center text-2xl uppercase py-2 border-b border-b-gray-800 tracking-wider"
          style={{
