  ...
  return (
    ...
    >
      <div className="flex flex-row pt-3 gap-2 items-center relative">
        ...
        <input
          ref={inputRef}
          className={`w-full text-lg p-2 pr-6 rounded-full focus:outline-none border`}
          style={{
        ...
        <span
          ref={hiddenInputRef}
          className="absolute top-0 left-0 text-lg pl-3 text-amber-500 pointer-events-none opacity-0"
        >
          {message.replaceAll(" ", "\u00a0")}
        </span>
        <button
          ...
          onClick={handleSend}
          className={`text-lg uppercase text-${accentColor}-500 hover:bg-${accentColor}-950 p-2 rounded-md opacity-${
